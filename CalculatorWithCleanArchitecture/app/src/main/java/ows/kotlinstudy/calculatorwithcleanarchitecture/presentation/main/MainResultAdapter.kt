...
import ows.kotlinstudy.calculatorwithcleanarchitecture.databinding.ItemResultBinding
import ows.kotlinstudy.mvcexample.model.db.entity.ResultEntity

class MainResultAdapter : ListAdapter<ResultEntity, MainResultAdapter.ResultViewHolder>(diffUtil) {
